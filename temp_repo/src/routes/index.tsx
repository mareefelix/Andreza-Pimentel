...
import quoteBotanical from "@/assets/quote-botanical.png";
import andrezaPortrait from "@/assets/andreza-portrait.webp";
import andrezaOffice from "@/assets/andreza-office.webp";
...
function Nav() {
  ...
  return (
    ...
    >
      <a href="#topo" className="font-serif italic text-lg tracking-wide text-foreground/80">
        andreza <span className="font-script text-2xl">pimentel</span>
      </a>
    ...
    <section id="topo" className="relative min-h-screen overflow-hidden" style={{ background: "linear-gradient(180deg, #CCE7D9 0%, #d8ecdf 60%, #f4f1ea 100%)" }}>
      <div className="relative max-w-7xl mx-auto px-8 md:px-16 pt-28 md:pt-32 pb-16 grid md:grid-cols-12 gap-12 items-center">
        <div className="md:col-span-7 relative z-10">
          <p className="text-xs uppercase tracking-[0.35em] text-foreground/55 mb-8">Psicologia clínica · CRP 02/17292</p>
          ...
          <p className="mt-10 max-w-md text-base md:text-lg text-foreground/65 leading-relaxed font-light">
        ...
        <div className="md:col-span-5 relative">
          <div className="relative">
            <div className="aspect-[4/5] overflow-hidden rounded-sm shadow-[0_40px_90px_-30px_rgba(50,70,60,0.4)]">
              <img
                src={andrezaPortrait}
...
const helps = [
  { title: "Adolescentes", text: "Acolhimento para travessias, identidade, ansiedade e relações na fase mais sensível da vida." },
  { title: "Adultos", text: "Espaço para olhar a própria história, reconhecer padrões e construir escolhas mais inteiras." },
  { title: "Idosos", text: "Cuidado com memórias, lutos, recomeços e a sabedoria de viver com presença." },
  { title: "Casais", text: "Reconstruir a escuta entre dois — diálogo, intimidade, conflitos e novos acordos." },
...
function HowIHelp() {
  return (
    <section id="ajuda" className="py-20 md:py-28 px-8 md:px-16 paper-texture" style={{ background: "linear-gradient(180deg, #f4f1ea 0%, #efece4 50%, #e9efe5 100%)" }}>
...
function About() {
  return (
    <section id="sobre" className="py-20 md:py-28 px-8 md:px-16 relative overflow-hidden" style={{ background: "linear-gradient(180deg, #e9efe5 0%, #f1efe6 50%, #fcfaf5 100%)" }}>
        ...
        <Reveal className="md:col-span-5 relative">
          <div className="relative">
            <div className="aspect-[4/5] rounded-sm overflow-hidden relative shadow-[0_30px_80px_-30px_rgba(60,80,70,0.35)]">
              <img src={andrezaOffice} alt="Consultório de Andreza Pimentel" className="w-full h-full object-cover" />
            </div>
          </div>
        ...
        <Reveal className="md:col-span-7" style={{ transitionDelay: "120ms" }}>
          ...
          <div className="space-y-6 text-foreground/70 leading-relaxed font-light">
            <p>
              ...
              em momentos de travessia — encontros e despedidas, escolhas difíceis,
          ...
          <p className="mt-8 font-serif italic text-lg text-foreground/65">
...
const steps = [
  ...
  { n: "IV", title: "O cuidado contínuo", text: "Reavaliamos juntas a caminhada, sempre com transparência e ética." },
];

function HowItWorks() {
  return (
    <section id="terapia" className="py-20 md:py-28 px-8 md:px-16 relative" style={{ background: "linear-gradient(180deg, #fcfaf5 0%, #f3f1e8 50%, #e9efe5 100%)" }}>
      <div className="max-w-5xl mx-auto">
        <Reveal className="text-center mb-24">
          <p className="text-xs uppercase tracking-[0.35em] text-muted-foreground mb-4">Como funciona a terapia</p>
          <h2 className="font-serif text-4xl md:text-6xl text-foreground/90 leading-tight">
            Um caminho feito
            <span className="font-script italic text-primary block text-5xl md:text-7xl mt-2">com você, ao seu tempo.</span>
          </h2>
        </Reveal>
...
const testimonials = [
  { text: "Encontrei na Andreza uma escuta que eu nem sabia que precisava. Saio das sessões mais leve, mais minha.", who: "Paciente, há 2 anos em terapia" },
  { text: "É raro encontrar tanta delicadeza junta com tanta firmeza. Ela cuida sem amenizar — e isso transforma.", who: "Atendimento individual" },
  { text: "Mudou a forma como eu e meu companheiro conversamos. Voltamos a nos ouvir de verdade.", who: "Terapia de casal" },
  { text: "Um espaço de profundo respeito. Me senti acolhida desde o primeiro encontro.", who: "Paciente adulta" },
];

function Testimonials() {
  return (
    <section className="py-20 md:py-28 px-8 md:px-16 relative" style={{ background: "linear-gradient(180deg, #e9efe5 0%, #dde7dc 50%, #fcfaf5 100%)" }}>
      <div className="max-w-6xl mx-auto">
        <Reveal className="text-center mb-20">
...
function FAQ() {
  ...
  return (
    <section id="faq" className="py-20 md:py-28 px-8 md:px-16" style={{ background: "linear-gradient(180deg, #fcfaf5 0%, #e6eee0 60%, #CCE7D9 100%)" }}>
...
function Contact() {
  return (
    <section id="contato" className="py-20 md:py-28 px-8 md:px-16 relative overflow-hidden" style={{ background: "linear-gradient(180deg, #CCE7D9 0%, #bcd9c6 70%, #9eb6a5 100%)" }}>
      <div className="absolute top-10 right-10 opacity-20 w-64">
        <img src={quoteBotanical} alt="" className="w-full mix-blend-multiply" />
      </div>
      <Reveal className="relative max-w-5xl mx-auto text-center">
        ...
        <p className="mt-10 max-w-xl mx-auto text-foreground/70 font-light text-lg leading-relaxed">
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-10 text-left max-w-3xl mx-auto">
          <div>
            <p className="text-[10px] uppercase tracking-[0.35em] text-foreground/50 mb-3">Endereço</p>
            <p className="font-serif text-lg text-foreground/85 leading-snug">
              R. Dom Rinaldi, 40<br />São José, Carpina — PE<br />55815-095
            </p>
          </div>
          <div>
            <p className="text-[10px] uppercase tracking-[0.35em] text-foreground/50 mb-3">WhatsApp</p>
            <a href={WHATSAPP} target="_blank" rel="noopener noreferrer" className="font-serif text-lg text-foreground/85 hover:text-primary transition">
              (81) 99956-6997
            </a>
          </div>
          <div>
            <p className="text-[10px] uppercase tracking-[0.35em] text-foreground/50 mb-3">Instagram</p>
            <a href="https://www.instagram.com/psiandrezapimentel/" target="_blank" rel="noopener noreferrer" className="font-serif text-lg text-foreground/85 hover:text-primary transition">
              @psiandrezapimentel
            </a>
          </div>
        </div>
  ...
  return (
    <footer className="px-8 md:px-16 py-16" style={{ background: "linear-gradient(180deg, #9eb6a5 0%, #4a5a4f 25%, #2d3a31 100%)", color: "#e8e2d1" }}>
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10 items-start">
        <div>
          <p className="font-script text-3xl text-cream/90">Andreza Pimentel</p>
          <p className="mt-2 text-xs uppercase tracking-[0.3em] text-cream/50">Psicóloga · CRP 02/17292</p>
        </div>
      ...
      <div className="max-w-6xl mx-auto mt-12 pt-8 border-t border-cream/15 flex flex-col md:flex-row justify-between gap-3 text-xs text-cream/45">
        <p>© {new Date().getFullYear()} Andreza Pimentel. Todos os direitos reservados.</p>
        <p className="italic">Desenvolvido por <span className="font-script text-base text-cream/70">Maree Feliz</span></p>
      </div>
    </footer>
  );
}
